...
CATALINA.ServiceWorkerRegistration = (function () {
  'use strict';
    ...
    if (!isAlreadyRegistered) {
      ...
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register(URL, {
          ...
          CATALINA.Analytics.trackError('navigator.serviceWorker.register() error', e);
  ...
  if (navigator.serviceWorker && navigator.serviceWorker.controller) {
    navigator.serviceWorker.controller.onstatechange = function (event) {
      if (event.target.state === 'redundant') {
        ...
        if (CATALINA.Elements && CATALINA.Elements.Template &&
          CATALINA.Elements.Template.$.toast.showMessage) {
          CATALINA.Elements.Template.$.toast.showMessage(
